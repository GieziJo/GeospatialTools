This Folder contains a version of the algorithm used for the [Global Flood Model (GFD)](https://github.com/cloudtostreet/MODIS_GlobalFloodDatabase) updated to Python 3 and stripped to the minimum.
